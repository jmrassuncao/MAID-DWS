...
char ssid[] = YOUR_WIFI_SSID; //char ssid[] = "UNIVERSE";
...
#define STATIC_IP_ADDRESS  192,168,1,222
#define SUBNET_MASK        255,255,255,0 // REQUIRED for ESP8266_WIFI, optional for others
#define GATEWAY_IP_ADDRESS 192,168,1,0       // REQUIRED for ESP8266_WIFI, optional for others 0,0,0,0
...
char wpa_passphrase[] = YOUR_WIFI_PASSWD; //char wpa_passphrase[] = "your_wpa_passphrase";
...
byte wep_index = 0;
char wep_key[] = YOUR_WIFI_PASSWD; //char wep_key[] = "your_wep_key";
